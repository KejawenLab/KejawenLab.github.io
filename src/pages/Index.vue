  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="text-6xl leading-tight">Kejawen Lab</div>
        <div class="text-3xl text-green-700 leading-tight">Indie Developer</div>
      </div>
      <div class="mt-8 sm:mt-0 w-7/12">
    ...
    <div class="overflow-x-hidden">
      ...
      >
        <h2 class="font-bold mb-6 text-4xl" id="projects">Projects</h2>
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            <div>Semart Skeleton</div>
            <div
              class="text-lg text-gray-600"
            >Semart Skeleton adalah sebuah skeleton atau boilerplate atau kerangka awal untuk memulai sebuah proyek. Dibangun dengan menggunakan framework Symfony dan berbagai bundle serta diramu oleh Developer yang telah berpengalaman lebih dari 7 tahun menggunakan Symfony.</div>
          </li>
          <li class="checkmark mb-6">
            <div>SemartHris</div>
            <div
              class="text-lg text-gray-600"
            >SemartHris adalah Enterprise Grade Human Resources Information System (HRIS) yang dapat digunakan untuk membantu memudahkan tugas HRD Perusahaan.</div>
          </li>
        </ul>
      </div>
      <!-- end projects -->
      ...
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="responsive-container">
          <iframe
            ...
            src="https://www.youtube.com/embed/sT4dMKSA1-A"
            style="border:0;"
    ...
    <div class="newsletter bg-background-tertiary">
      <div class="container-inner mx-auto py-16 pb-8 text-center textl-xl">
        <h2 class="text-2xl font-bold mb-8">Join Newsletter</h2>
